...
tab_tool, tab_template = st.tabs(["⚙️ Matcher Tool", "📥 Download Template"])
with tab_tool:
...
with tab_template:
    ...
    st.markdown("Use this template to prepare your capacitor values before uploading.")
    ...
    st.download_button(
        ...
        data=buffer,
        file_name="CapacitorMatcherTemplate.xlsx",
        mime="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
    )
